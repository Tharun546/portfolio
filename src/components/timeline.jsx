...
export const Timeline = ({ data }) => {
  ...
  return (
    <div className="w-full font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto pt-24 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-white max-w-4xl">
          Changelog from my journey
        </h2>
        <p className="text-neutral-300 text-sm md:text-base max-w-sm">
          I've been working as a Full Stack Developer and Mobile Developer.
          Below is a timeline of my journey.
        </p>
      </div>
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-10 items-center top-10 md:top-40 self-start max-w-xs lg:max-w-sm md:w-full">
